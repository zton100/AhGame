...
- Remaining: settings-page manual save/export/import placeholders, deeper save validation for future gameplay fields, S04 UI character page integration, later S06 status/difficulty formula slices, drop-to-inventory integration, and equipment card UI/detail modal.
