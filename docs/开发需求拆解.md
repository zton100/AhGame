...
- Remaining: settings-page manual save/export/import placeholders, deeper save validation for future gameplay fields, S04 UI character page integration, later S06 status/difficulty formula slices, S08 affix rolls, and S07 equip/compare services.
