...
- Remaining: Issue 013 auto-save lifecycle hooks, settings-page manual save/export/import placeholders, and deeper save validation for future gameplay fields.
