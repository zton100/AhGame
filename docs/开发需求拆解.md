...
- Remaining: settings-page manual save/export/import placeholders, deeper save validation for future gameplay fields, S04 UI character page integration, later S06 status/difficulty formula slices, BD tag aggregation/scoring, and S07 equipment compare/inventory integration.
